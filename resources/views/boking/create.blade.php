                    ...
                    {{-- <div class="container" > --}}
                      <div class="row justify-content-center">
                        <div class="col-md-12">
                          ...
                          @endif
                          <form action="{{route('boking.store')}}" method="post" enctype="multipart/form-data" style="max-width: none;">
                              @csrf
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="bayar" id="inputBayar" class="form-control" required>
                                      ...
                                      <option value="BNI/7783726">BNI / 7783726</option>
                                      <option value="BRI/958473627">BRI / 958473627</option>
                                      <option value="Dana/0823857549504">Dana / 0823857549504</option>
                                    </select>
                                </div>
